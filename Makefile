...
legendre_transform_module.o : glatwgt_module.o alf_module.o constant_module.o io_module.o
init_module.o : io_module.o sphere_module.o legendre_transform_module.o constant_module.o uv_module.o
upstream_module.o : constant_module.o sphere_module.o grid_module.o time_module.o interpolate_module.o
...
grid_module.o : constant_module.o legendre_transform_module.o init_module.o
uv_module.o : constant_module.o
eulerian_module.o : constant_module.o io_module.o grid_module.o time_module.o legendre_transform_module.o 
semilag_module.o : constant_module.o io_module.o grid_module.o time_module.o legendre_transform_module.o upstream_module.o
nisl_module.o : constant_module.o io_module.o grid_module.o time_module.o legendre_transform_module.o upstream_module.o sphere_module.o
main.o : eulerian_module.o semilag_module.o nisl_module.o constant_module.o
